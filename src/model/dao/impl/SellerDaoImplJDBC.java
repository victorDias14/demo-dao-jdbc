...
public class SellerDaoImplJDBC implements SellerDao {
	...
	public Seller findById(Integer id) {
		...
		try {
			...
			if (rs.next()) {
				Department dep = (Department) instantiateDepartment(rs);				
				Seller obj = (Seller) instantiateSeller(rs, dep);				
				return obj;
			}
	...
	private Object instantiateSeller(ResultSet rs, Department dep) throws SQLException {
		var obj = new Seller();
	...
	private Object instantiateDepartment(ResultSet rs) throws SQLException {
